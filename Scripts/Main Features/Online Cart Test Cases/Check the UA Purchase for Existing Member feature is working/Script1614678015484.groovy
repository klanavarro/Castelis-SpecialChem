...
WebUI.scrollToElement(findTestObject('Online Cart/a_Test Courses Selection'), 3)

WebUI.click(findTestObject('Online Cart/a_Test Courses Selection'))

WebUI.click(findTestObject('Online Cart/a_Test Course Add to Cart'))

WebUI.click(findTestObject('Online Cart/a_Add To Cart'))

WebUI.click(findTestObject('Online Cart/a_Close Checkout'))

WebUI.click(findTestObject('Online Cart/a_Test Course Checkout'))
...
WebUI.click(findTestObject('Online Cart/a_Team Leader Checklist'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Online Cart/a_Pay By Credits or Unlimited Access'), 3)

WebUI.click(findTestObject('Online Cart/a_Pay By Credits or Unlimited Access'))
