...
WebUI.click(findTestObject('Online Cart/a_Remove Product in Cart'))

WebUI.verifyElementVisible(findTestObject('Online Cart/div_Verify Removed Product in Cart'))
