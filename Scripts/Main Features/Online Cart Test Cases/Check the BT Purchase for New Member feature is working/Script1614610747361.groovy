...
WebUI.openBrowser('https://cosmetics.uat.specialchem.com/online-course/1091-rheology-viscosity-shear-flow?src=MenuPush')

WebUI.maximizeWindow()

WebUI.waitForElementVisible(findTestObject('Online Cart/a_Recorded Course to your Cart'), 3)

WebUI.click(findTestObject('Online Cart/a_Recorded Course to your Cart'))
