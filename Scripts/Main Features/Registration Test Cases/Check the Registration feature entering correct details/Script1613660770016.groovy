...
WebUI.setText(findTestObject('Registration/input_Professional_Email'), ('qa.castelis.test' + String.valueOf(randomNumber)) + 
    '@yopmail.com')
...
WebUI.verifyElementVisible(findTestObject('Registration/div_Please confirm your email'), FailureHandling.STOP_ON_FAILURE)
