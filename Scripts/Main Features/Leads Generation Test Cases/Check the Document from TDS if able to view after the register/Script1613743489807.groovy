...
WebUI.click(findTestObject('Lead Generation/Document TDS/div_Surfadol Acetylenic Diols Additives - Brochure'))
...
WebUI.verifyElementVisible(findTestObject('Lead Generation/Document TDS/div_Please confirm your email              _d21d2a'))
