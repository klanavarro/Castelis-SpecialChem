...
WebUI.setText(findTestObject('Lead Generation/Sample a Request/input__content_0form_Product Grade'), 'test')

WebUI.verifyElementVisible(findTestObject('Lead Generation/Sample a Request/div_Your information Step2'))

WebUI.selectOptionByIndex(findTestObject('Lead Generation/Sample a Request/drop_Down1_Goal of your project'), 1, FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByIndex(findTestObject('Lead Generation/Sample a Request/drop_Down2_Project phase'), 1, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Lead Generation/Sample a Request/textarea__content_0form_System Requirements'), 'Test description')

WebUI.scrollToElement(findTestObject('Lead Generation/Sample a Request/span_Next2'), 5)

WebUI.click(findTestObject('Lead Generation/Sample a Request/span_Next2'))

WebUI.delay(3)

WebUI.verifyElementVisible(findTestObject('Lead Generation/Sample a Request/div_Last Step'))

WebUI.click(findTestObject('Lead Generation/div_OK, I want to continue'))
