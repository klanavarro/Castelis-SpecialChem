...
WebUI.selectOptionByIndex(findTestObject('Lead Generation/Contact Supplier/drop_Down1_Goal of your project'), 1, FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByIndex(findTestObject('Lead Generation/Contact Supplier/drop_Down2_Project phase'), 1, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Lead Generation/Contact Supplier/textarea__content_0form_System Requirements'), 'Test description')

WebUI.click(findTestObject('Lead Generation/Contact Supplier/span_Next2'))

WebUI.verifyElementVisible(findTestObject('Lead Generation/div_Banner Step 3'))

WebUI.click(findTestObject('Lead Generation/div_OK, I want to continue'))

WebUI.verifyElementVisible(findTestObject('Lead Generation/Contact Supplier/div_Confirmation Contact'))
