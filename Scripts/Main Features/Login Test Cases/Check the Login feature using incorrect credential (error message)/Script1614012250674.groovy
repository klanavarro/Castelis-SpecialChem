...
WebUI.setText(findTestObject('Login/input_Password_txtPasswordlogin'), 'asdlkjasdlkj')

WebUI.verifyElementVisible(findTestObject('Login/div_Type error message'), FailureHandling.STOP_ON_FAILURE)
