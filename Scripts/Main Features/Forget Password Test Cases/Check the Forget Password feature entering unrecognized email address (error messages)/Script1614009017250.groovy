...
WebUI.setText(findTestObject('Object Repository/Forget Password/input_Your Email_ctl06content_1bodycontent__b805cb'), 'qwertyasdf123@gmailtest.com')

WebUI.click(findTestObject('Object Repository/Forget Password/span_Send'))

WebUI.delay(3)

WebUI.verifyElementVisible(findTestObject('Forget Password/span_Enter your Email error message'))
